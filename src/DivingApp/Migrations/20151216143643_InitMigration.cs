    ...
    public partial class InitMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CountryKod = table.Column<int>(isNullable: false),
                    Description = table.Column<string>(isNullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyStamp = table.Column<string>(isNullable: true),
                    Country = table.Column<int>(isNullable: true),
                    DicCountryCountryKod = table.Column<int>(isNullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountriesCountryKod = table.Column<int>(isNullable: true),
